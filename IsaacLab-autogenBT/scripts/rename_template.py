...
It renames all the occurrences of autogen_bt (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the autogen_bt folder
        os.rename(
            os.path.join(root_dir_path, "exts", "autogen_bt", "autogen_bt"),
            os.path.join(root_dir_path, "exts", "autogen_bt", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "autogen_bt"), os.path.join(root_dir_path, "exts", new_name))
