...
{
  new (message_memory) autogen_bt_interface::msg::StringStamped(_init);
}

void StringStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autogen_bt_interface::msg::StringStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StringStamped_message_member_array[2] = {
  {
    ...
    offsetof(autogen_bt_interface::msg::StringStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autogen_bt_interface::msg::StringStamped, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StringStamped_message_members = {
  "autogen_bt_interface::msg",  // message namespace
  "StringStamped",  // message name
  2,  // number of fields
  sizeof(autogen_bt_interface::msg::StringStamped),
...
get_message_type_support_handle<autogen_bt_interface::msg::StringStamped>()
{
  return &::autogen_bt_interface::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autogen_bt_interface, msg, StringStamped)() {
  return &::autogen_bt_interface::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
