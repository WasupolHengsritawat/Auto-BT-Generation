...
#include "autogen_bt_interface/srv/detail/charging_request__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autogen_bt_interface::srv::ChargingRequest_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autogen_bt_interface::srv::ChargingRequest_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autogen_bt_interface::srv::ChargingRequest_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChargingRequest_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autogen_bt_interface::srv::ChargingRequest_Request *>(
...
static size_t _ChargingRequest_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ChargingRequest_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ChargingRequest_Request__callbacks = {
...
static rosidl_message_type_support_t _ChargingRequest_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChargingRequest_Request__callbacks,
...
{
  return &autogen_bt_interface::srv::typesupport_fastrtps_cpp::_ChargingRequest_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autogen_bt_interface::srv::ChargingRequest_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autogen_bt_interface::srv::ChargingRequest_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autogen_bt_interface::srv::ChargingRequest_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChargingRequest_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autogen_bt_interface::srv::ChargingRequest_Response *>(
...
static size_t _ChargingRequest_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ChargingRequest_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ChargingRequest_Response__callbacks = {
  "autogen_bt_interface::srv",
...
static rosidl_message_type_support_t _ChargingRequest_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChargingRequest_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &autogen_bt_interface::srv::typesupport_fastrtps_cpp::_ChargingRequest_Response__handle;
}
...
static service_type_support_callbacks_t _ChargingRequest__callbacks = {
  "autogen_bt_interface::srv",
  "ChargingRequest",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autogen_bt_interface, srv, ChargingRequest_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autogen_bt_interface, srv, ChargingRequest_Response)(),
...
static rosidl_service_type_support_t _ChargingRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChargingRequest__callbacks,
...
{
  return &autogen_bt_interface::srv::typesupport_fastrtps_cpp::_ChargingRequest__handle;
}
