...
#include "autogen_bt_interface/msg/detail/string_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autogen_bt_interface::msg::StringStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autogen_bt_interface::msg::StringStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autogen_bt_interface::msg::StringStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autogen_bt_interface::msg::StringStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autogen_bt_interface::msg::StringStamped *>(
    untyped_ros_message);
...
{
  return &autogen_bt_interface::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autogen_bt_interface, msg, StringStamped)() {
  return &autogen_bt_interface::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
