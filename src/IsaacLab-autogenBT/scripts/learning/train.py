...
def dataset_generation(node_dict, nodes_limit, num_search_agents, num_search, eval_env, policy_net, num_node_to_explore = 10, device='cuda:0', verbose = False):
...
if __name__ == "__main__":
    ...
    eval_env = MultiBTEnv(node_dict,
                          nodes_limit,
                          num_envs=args_cli.num_eval_agents, 
                          simulation_app=simulation_app, 
                          number_of_target_to_success=number_of_target_to_success, 
                          number_of_spawned_objects=number_of_spawned_objects,
                          sim_step_limit=sim_step_limit,
                          env_spacing=args_cli.env_spacing, device=device)
